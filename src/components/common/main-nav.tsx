...
import { BookOpen, Home, LayoutGrid, Pencil, Bot, Route, FlaskConical, User, MessageSquare, BarChart3, Gamepad2, Terminal, Wand2 } from 'lucide-react';
...
const menuItems = [
  ...
  { href: '/generate-project', label: 'AI Generator', icon: Wand2 },
