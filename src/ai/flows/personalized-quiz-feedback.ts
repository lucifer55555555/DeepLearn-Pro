...
const prompt = ai.definePrompt({
  ...
  Provide feedback that is encouraging and actionable, focusing on specific concepts or areas where the user can focus their learning efforts. The feedback should be no more than 200 words.
  Feedback:
`,
});
